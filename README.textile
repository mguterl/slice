...
@install ruby ruby1.8-dev irb ri rdoc libopenssl-ruby1.8 zlib1g-dev libssl-dev rubygems -y@
...
@sudo /opt/ruby-enterprise-1.8.6-20080810/bin/gem install rake passenger@
