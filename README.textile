...
FIXME for some reason the directories while created under your home directory are being created/owned by root
Going to your server and @sudo chown deploy:deploy -R ~/public_html@
@cap deploy:cold@
FIXME after this runs if you have git submodules you'll need to go into your shared/cached-copy on the server and run
@git submodule init@
